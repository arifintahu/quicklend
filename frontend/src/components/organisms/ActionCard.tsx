...
import { MarketData } from '@/lib/mock/types';
      ...
      >
        <GlassCard className="w-full max-w-md relative border border-[#00F0FF]/20 glass-panel-strong">
            ...
            <div className="flex items-center gap-2 mb-6">
                ...
                <div>
                    <h2 className="text-xl font-bold">{asset.asset.name}</h2>
                    <span className="text-sm font-normal text-gray-500">{asset.asset.symbol}</span>
                </div>
            </div>
            ...
            >
                {action === 'supply' ? 'Supply' : 'Borrow'} {asset.asset.symbol}
            </Button>
